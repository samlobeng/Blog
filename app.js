...
app.get("/", function(req,res){
  //find posts and render onto homepage
...
app.post("/compose",function(req,res){
  //document that contains the post in the db
  const post = new Post ({
...
app.get("/posts/:postId", function(req, res) {
  //find and display post based on id
